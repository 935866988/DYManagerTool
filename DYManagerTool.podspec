...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DYManagerTool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/935866988@qq.com/DYManagerTool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '935866988@qq.com' => 'liangyongsheng@danyuantech.com' }
  s.source           = { :git => 'https://github.com/935866988@qq.com/DYManagerTool.git', :tag => s.version.to_s }
